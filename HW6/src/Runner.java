public class Runner {
    public static void main (String[] args) {
        ...
        newCar [4] = new Car (5, 2013, 12000, 1982, "Ford", "Mondeo", "pink");
        newCar [5] = new Car (6, 2019, 19500, 6599, "Peugeot", "308", "silver");
        newCar [6] = new Car (7, 2015, 18500, 7399, "Peugeot", "307", "yellow");
